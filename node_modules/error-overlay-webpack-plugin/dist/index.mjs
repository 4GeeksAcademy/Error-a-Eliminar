...
class ErrorOverlayPlugin {
  apply(compiler) {
    ...
    if (devServerEnabled) {
      ...
      sockOptions.sockPath = ((_d = (_c = compiler.options.devServer.client) == null ? void 0 : _c.webSocketURL) == null ? void 0 : _d.pathname) || ((_e = compiler.options.devServer.webSocketServer) == null ? void 0 : _e.options.path) || "/ws";
